...
#Output spatial versio of samples and full sample set
SampleStrataOut<- SampleStrataIn %>%
  dplyr::select(-c(all_of(Requ),Sampled,SampleType,YearSampled)) %>%
  right_join(SampleStrataM, by=c('Wetland_Co'))
...
st_write(SampleStrataGeo, file.path(dataOutDirTS,"SampleStrataGeo.shp"),
         delete_dsn=TRUE)
st_write(SampleStrataGeo, file.path(dataOutDirTS,"SampleStrataGeo.GeoJSON"),
                                  delete_dsn=TRUE)
...
st_write(SamplesGeo, file.path(dataOutDirTS,"SamplesGeo.shp"),
         delete_dsn=TRUE)
st_write(SamplesGeo, file.path(dataOutDirTS,"SamplesGeo.GeoJSON"),
                                  delete_dsn=TRUE)
#KML versions
